...
Tests that read-only memory protections are working correctly.
This verifies that kernel code segments are properly protected.
"""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Read-Only Visibility Test",
